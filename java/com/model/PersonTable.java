...
public class PersonTable {
	public static void main(String[] args) {
		...
		Person validPerson1= new Person("Raj","Nellai Street,Karur");
		Customer validPerson2= new Customer("Sri","Nehru Street,Madurai","sri123@gmail.com","Regular","9845672462");
		
		Employee validPerson3= new Employee("CEO", 10000, LocalDate.of(2020, 10, 07),"Kavi","Gandhi street, Chennai");
